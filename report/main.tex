...
\begin{description}
	...
	\item[all\_done]{Boolean-like variable indicating whether or not the entire directory tree has been traversed.}
	\item[spawned]{Boolean-like variable indicating whether or not other threads have been spawned yet.}
